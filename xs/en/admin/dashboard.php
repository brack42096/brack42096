...
if (!empty($_SESSION['username']) == $username or($_POST['username'] == $username && $_POST['password'] == $password)) {
    ...
    if ($handle = opendir($dir)) {
        ...
        echo '<br><br><br><center><button>Version</button> <button>User</button>  <button class=abc>By</button><br><button><b>20.03</b></button> <button><b>'.$_SESSION['username'].'</b></button></a>  <a href=https://github.com/graysuit target="_blank"><button class=abc><b>Gray Suit</b></button></a></center>';
        closedir($handle);
    }
} else {
